...
sap.ui.define([
		...
		return BaseController.extend("northwind.northwind.controller.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("northwind.northwind.view.ViewSettingsDialog", this);
